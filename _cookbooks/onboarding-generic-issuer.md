---
title: How to integrate the swiyu Generic Issuer
toc: true
toc_sticky: true
...
This software, together with the other generic components provided, forms a collection of APIs allowing the issuance and verification of verifiable credentials, as visualized in the image below. Additional documentation can be found in this [GitHub repository](https://github.com/swiyu-admin-ch/swiyu-issuer).
...
>
> The required steps are explained more thoroughly in the [Base- and Trust Registry Cookbook](https://swiyu-admin-ch.github.io/cookbooks/onboarding-base-and-trust-registry/)
...
>  ⚠️ It's recommended to store the value of `"statusRegistryUrl"` response field, as it is needed in later steps and will
