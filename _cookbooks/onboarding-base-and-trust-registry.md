...
The id is required when uploading your DID log and will be further referenced as IDENTIFIER_REGISTRY_ID
...
You may also upload the file generated by the didtoolbox directly with the @ notation:
```bash
