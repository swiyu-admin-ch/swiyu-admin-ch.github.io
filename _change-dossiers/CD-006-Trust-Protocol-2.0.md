...
* 🆕 Shift usage and issuance to the Sandbox wallet [Android see assets](https://github.com/swiyu-admin-ch/eidch-android-wallet/releases) and [iOS](https://apps.apple.com/us/app/swiyu-sandbox-wallet/id6771296857) if not already done, to validate the TP2.0 migration ahead of the Contract phase.
