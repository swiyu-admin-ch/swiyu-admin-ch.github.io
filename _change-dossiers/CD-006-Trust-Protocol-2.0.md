...
Status: Released <br>
Published: 13.08.2026 (edited 16.09.2026)<br>
...
* 🚨 From the Contract phase (Wallet 2.x.x, Mid-November 2026, exact date tba): the Wallet will no longer accept TP1.0 trust artefacts. All DIDs consumed by the Wallet must be trust-onboarded with TP2.0 before this date, or they will be rejected.
...
* 🚨 Upgrade to Generic Issuer 5.x.x (Migrate phase, ~October 2026, exact date tba): remove all usage of TP1.0 and old endpoints; switch to TP2.0 only.
...
* 19.08.2026 Wallet 1.17.x (enforced), TP2.0 support introduced alongside TP1.0; TP1.0 as fallback. Expand phase begins.
* 10.2026 (tba)	Generic Issuer & Verifier 5.x.x available, TP1.0 and old endpoints removed, TP2.0 only. Migrate phase begins.
* 10.2026 to 2026-10 (tba)	Ecosystem migrates to Generic Issuer & Verifier 5.x.x; DIDs re-onboarded with TP2.0 trust statements.
* Mid-November (tba)	Deadline for ecosystem migration, all DIDs must be TP2.0 trust-onboarded.
* Mid-November (tba)	Contract step: Wallet 2.0 removes TP1.0 support. Wallet no longer accepts TP1.0 trust artefacts; Prod Wallet no longer works against Sandbox.


[![trust-protocol-2-0-roadmap](/assets/images/2026_09_Roadmap.png)](/assets/images/2026_09_Roadmap.png)
