...
| **VC-Format/Signature-Scheme Combination**       | [SD-JWT VC](https://datatracker.ietf.org/doc/draft-ietf-oauth-sd-jwt-vc/) & ECDSA   | **SELECTED** <br> In accordance with [Swiss profile](https://swiyu-admin-ch.github.io/specifications/interoperability-profile/) | **SELECTED** |
...
| **VC appearance**       | Visualization of Verifiable Credential with [OCA](https://swiyu-admin-ch.github.io/specifications/oca/) | **SELECTED** | **SELECTED**|
